...
return [
    ...
    'app_profil_show' => [['id'], ['_controller' => 'App\\Controller\\ProfilController::index'], [], [['text', '/profil/'], ['variable', '/', '[^/]++', 'id', true]], [], [], []],
    'app_profil_modifie' => [['id'], ['_controller' => 'App\\Controller\\ProfilController::modifie'], [], [['text', '/profil/modifie'], ['variable', '/', '[^/]++', 'id', true]], [], [], []],
