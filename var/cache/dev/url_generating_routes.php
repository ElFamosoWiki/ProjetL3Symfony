...
return [
    ...
    'app_show_inscrit' => [['id'], ['_controller' => 'App\\Controller\\CreateEventController::showReg'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/show/inscrit']], [], [], []],
    ...
    'app_image_user_show' => [['id'], ['_controller' => 'App\\Controller\\ImageUserController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/image/usercategorie']], [], [], []],
    ...
    'app_jeu_index' => [[], ['_controller' => 'App\\Controller\\JeuController::index'], [], [['text', '/jeu/']], [], [], []],
    'app_jeu_new' => [[], ['_controller' => 'App\\Controller\\JeuController::new'], [], [['text', '/jeu/new']], [], [], []],
    'app_jeu_show' => [['id'], ['_controller' => 'App\\Controller\\JeuController::show'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/jeu']], [], [], []],
    'app_jeu_edit' => [['id'], ['_controller' => 'App\\Controller\\JeuController::edit'], [], [['text', '/edit'], ['variable', '/', '[^/]++', 'id', true], ['text', '/jeu']], [], [], []],
    'app_jeu_delete' => [['id'], ['_controller' => 'App\\Controller\\JeuController::delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/jeu']], [], [], []],
    ...
    'app_organisateur_application' => [[], ['_controller' => 'App\\Controller\\OrganisateurApplicationController::index'], [], [['text', '/organisateur/application']], [], [], []],
